...
// ── SVG ISLAND BUILDER ───────────────────────────────
// Body: real tileset sprite (48×76 from Ground_grass_flying.png, 3× scale)
// stretched wide via preserveAspectRatio='none' to give proper squat shape.
// Decorations: real pixel-art sprites embedded as SVG <image> tags.
...
const _TREE  = 'data:image/png;base64,';
const _STAT  = 'data:image/png;base64,';
const _FLOW  = 'data:image/png;base64,';
const _CRYS  = 'data:image/png;base64,';
...
function svgIsle(cfg){
  ...
  // Body sprite: 144×228 native, stretched to w × bodyH
  // Keep same squat ratio as current working islands (0.62 height ratio)
  let bodyH = Math.round(w * 0.62);

  // The teal pool rim in the sprite sits at ~21% from top
  let rimY = Math.round(bodyH * 0.21);

  // Decoration sizes (if not overridden)
  // Each dec has a natural aspect; scale so height = 55% of rimY
  let decNatAspects = {tree:80/82, statue:86/58, flower:1, crystal:48/62};
  let nat = decNatAspects[dec] || 1;
  if(!decH) decH = Math.round(rimY * 0.90);
  if(!decW) decW = Math.round(decH * nat);
  let decX = Math.round((w - decW) / 2);
  let decY = rimY - decH + 4;

  // Waterfall: centred, starts at rim, hangs down body
  let wfDispW = Math.round(w * 0.62);
  let wfDispH = Math.round(wfDispW * (_WFH / _WFW));
  let wfX = Math.round((w - wfDispW) / 2);
  let wfY = rimY + Math.round(bodyH * 0.04);

  // Total SVG height: body + small gap for shadow
  let totalH = bodyH + 10;

  // Decoration image tag
  let decSrc = dec==='tree' ? _TREE : dec==='statue' ? _STAT : dec==='flower' ? _FLOW : _CRYS;
  let decTag = `<image href="${decSrc}" x="${decX}" y="${decY}" width="${decW}" height="${decH}" style="image-rendering:pixelated"/>`;

  // Waterfall tag
  let wfTag2 = waterfall
    ? `<image href="${_WF}" x="${wfX}" y="${wfY}" width="${wfDispW}" height="${wfDispH}" style="image-rendering:pixelated" opacity="0.90"/>`
    : '';
  ...
  let svg = `<svg viewBox="0 0 ${w} ${totalH}" width="${w}" height="${totalH}"
    ...
    <!-- Real tileset island body, stretched wide -->
    <image href="${_BODY}" x="0" y="0" width="${w}" height="${bodyH}"
           preserveAspectRatio="none" style="image-rendering:pixelated"/>
    <!-- Waterfall (Lernen + Gemeinschaft) -->
    ${wfTag2}
    <!-- Decoration sprite -->
    ${decTag}
    <!-- Drop shadow -->
