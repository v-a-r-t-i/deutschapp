...
// Body: clean 48x80 standalone island sprite, scaled 4x → 192x320
// Aspect ratio: height = width * (320/192)

const _ISLE_ASSETS = {
  body:    'data:image/png;base64,',
...
function svgIsle(cfg){
  let {w=180,decAsset='tree',decW=70,decH=80,decOffX=0,decOffY=0,badgeHtml=''}=cfg;
  // Body sprite native: 192w x 320h → scale to w, maintain aspect
  let bodyH=Math.round(w*(320/192));
  let totalH=bodyH+10;
  // Teal pool rim sits at roughly 18% from top of sprite
  let rimY=Math.round(bodyH*0.18);
  // Decoration: centred horizontally, bottom-anchored to rim top
  ...
  let decTag=decAsset
    ...
    : '';
  let svg=`<svg viewBox="0 0 ${w} ${totalH}" width="${w}" height="${totalH}" xmlns="http://www.w3.org/2000/svg" style="display:block;overflow:visible;image-rendering:pixelated">
    ...
    ${decTag}
    <ellipse cx="${w/2}" cy="${totalH-2}" rx="${w*0.30}" ry="4" fill="rgba(0,0,0,0.12)"/>
  </svg>`;
